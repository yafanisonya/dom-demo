...
var div = dom.create("<div><span>testDiv</span></div>");
var p = dom.create("<p>段落</p>"); //div2 = dom.create("   <td>hi</td>")
//console.log(div2);

var div3 = dom.create("<div>testDiv</div>");
dom.before(test, div);
dom.after(test, div);
...
console.log(dom.find('#test')[0]); //console.log('---')

console.log(dom.find('#siblings')[0]); //console.log('---')
...
dom.each(dom.children(dom.find('#siblings')[0]), function (n) {
  return dom.style(n, 'color', 'red');
});
console.log('---'); // const t = dom.find('#siblings')[0]
